...
/***/ "./node_modules/css-loader/index.js!./src/map/map.css":
/*!***************************************************!*\
  !*** ./node_modules/css-loader!./src/map/map.css ***!
  \***************************************************/
...
/* harmony import */ var _map_baidu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./map/baidu */ "./src/map/baidu.ts");

(function () {
    _map_baidu__WEBPACK_IMPORTED_MODULE_0__["default"].mapInit("container");
    window.map = _map_baidu__WEBPACK_IMPORTED_MODULE_0__["default"];
})();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./common */ "./src/map/common.ts");
...
/* harmony import */ var _mapbase__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mapbase */ "./src/map/mapbase.ts");
...
var BaiduMapProvider = (function (_super) {
    ...
    BaiduMapProvider.prototype.createBlock = function (point, opt) {
        ...
        var context = new _mapbase__WEBPACK_IMPORTED_MODULE_1__["BlockContextImp"](new BMap.Point(lng, lat), opt.settings.Pollutant);
    ...
    BaiduMapProvider.prototype.onMapBoundChanged = function () {
        ...
        this.on("boundChanged", { bound: { sw: bound.getSouthWest(), ne: bound.getNorthEast() } });
    };
    BaiduMapProvider.prototype.onCheckContextMenu = function () {
        ...
        if (!blocks) {
            ...
            setEnable("\u4FDD\u5B58", blocks.length > 0);
            setEnable("\u7EDF\u8BA1\u62A5\u8868", blocks.length > 0);
            setEnable("\u6A2A\u5411\u5207\u9762", blocks.length > 0);
            setEnable("\u7EB5\u5411\u5207\u9762", blocks.length > 0);
            setEnable("\u6E05\u9664", blocks.length > 0);
        }
        setEnable("\u9009\u62E9\u5206\u6790\u533A\u57DF", !this.analysisArea.isEnabled());
        setEnable("\u6E05\u9664\u5206\u6790\u533A\u57DF", this.analysisArea.isEnabled());
        setChecked("\u65E0\u4EBA\u673A\u8DDF\u968F", this.uavFollow);
        setChecked("\u65E0\u4EBA\u673A\u8DEF\u5F84", this.uavPath);
    };
    ...
    BaiduMapProvider.prototype.onSaveSelectedBlocks = function () {
        if (this.tempSelectedData && this.tempSelectedData.length) {
            this.on("savePoints", { points: this.tempSelectedData });
            delete this.tempSelectedData;
            return;
        }
        var blocks = this.blockGrid.selectedBlocks;
        if (blocks && blocks.length) {
            this.on("savePoints", { points: blocks.selectMany(function (o) { return o.context.getPoints(function (i) { return true; }).select(function (i) { return i.data; }); }) });
        }
    };
    ...
    BaiduMapProvider.prototype.getBlocksData = function (blocks) {
        ...
        return blocks.filter(function (o) { return o.context.color; }).select(function (o) {
            ...
            return {
                ...
                opacity: _this.blockGrid.options.settings.Opacity
            };
        });
    };
    BaiduMapProvider.prototype.onMapLoad = function (map) {
        ...
        map.centerAndZoom(new BMap.Point(113.140761, 23.033974), 17);
            ...
            if (_this.analysisArea.isEnabled() && !_this.analysisArea.getBounds()) {
                ...
                _this.blockGrid.blocks.forEach(function (b) {
                    if (o.bound.containsPoint(b.context.center)) {
                        if (o.event.shiftKey) {
                            _this.onSelectBlock(b, 2);
                        }
                        else if (o.event.ctrlKey) {
                            _this.onSelectBlock(b, 1);
                        }
                        else {
        ...
        this.subscribe("load", true);
        this.subscribe("clearAnalysisArea", true);
        this.subscribe("clearAspect", true);
        this.subscribe("horizontalAspect", true);
        this.subscribe("pointConvert", true);
        this.subscribe("savePoints", true);
        this.subscribe("selectAnalysisArea", true);
        this.subscribe("verticalAspect", true);
        this.on("load");
        var h = setInterval(function () {
            var i = jquery__WEBPACK_IMPORTED_MODULE_2__("a[title='到百度地图查看此区域']");
            var b = jquery__WEBPACK_IMPORTED_MODULE_2__("span[_cid='1']");
    ...
    BaiduMapProvider.prototype.mapInitMenu = function (edit) {
        var _this = this;
        ...
        if (edit) {
            this.menuItems = [
                createItem("\u5237\u65B0\u5730\u56FE", function (o) { return _this.onRefresh(); }),
                false,
                createItem("\u65E0\u4EBA\u673A\u5B9A\u4F4D", function (o) { return _this.onUavLoaction(); }),
                createItem("\u65E0\u4EBA\u673A\u8DDF\u968F", function (o) { return _this.uavFollow = !_this.uavFollow; }),
                createItem("\u65E0\u4EBA\u673A\u8DEF\u5F84", function (o) { return _this.uavPath = !_this.uavPath; }),
                false,
                createItem("\u4FDD\u5B58", function (o) { return _this.onSaveSelectedBlocks(); }),
                createItem("\u7EDF\u8BA1\u62A5\u8868", function (o) { return _this.onShowSelectedBlockReport(); }),
                createItem("\u6A2A\u5411\u5207\u9762", function (o) { return _this.onShowHorizontalAspect(); }),
                createItem("\u7EB5\u5411\u5207\u9762", function (o) { return _this.onShowVerticalAspect(); }),
                createItem("\u6E05\u9664", function (o) { return _this.onClearSelectedBlock(); }),
                false,
                createItem("\u9009\u62E9\u5206\u6790\u533A\u57DF", function (o) { return _this.analysisArea.enable(); }),
                createItem("\u6E05\u9664\u5206\u6790\u533A\u57DF", function (o) { return _this.analysisArea.disable(); }),
            ];
        }
        else {
            this.menuItems = [
    ...
    BaiduMapProvider.prototype.mapCenter = function (point) {
        if (point) {
    ...
    BaiduMapProvider.prototype.mapPointConvert = function (seq, p) {
        ...
        this.convertor.translate(points, 1, 5, function (o) {
            if (o.status == 0) {
                _this.on("pointConvert", { Seq: seq, Points: o.points });
            }
        });
    };
    BaiduMapProvider.prototype.mapShowTempReport = function (d) {
        ...
        if (data) {
            ...
            var time;
            var blocks = [];
            this.blockGrid.options.settings.Pollutant.forEach(function (pollutant) {
                var rp = {};
    ...
    BaiduMapProvider.prototype.gridInit = function (opt) {
        ...
        if (!opt.settings)
            opt.settings = {};
        if (!opt.settings.Opacity)
            opt.settings.Opacity = 0.5;
        if (!opt.settings.SideLength)
            opt.settings.SideLength = 100;
        if (!opt.settings.Pollutant)
            opt.settings.Pollutant = [{ Name: "", DisplayName: "", MaxValue: 0, MinValue: 0, Unit: "" }];
        ...
        blockGrid.blocks.forEach(function (block) {
            ...
            if (report) {
                ...
                if (block.context.color != color) {
                    ...
                    _this.on("blockChanged", { blocks: _this.getBlocksData(_this.blockGrid.blocks) });
                }
    ...
    BaiduMapProvider.prototype.uavAdd = function (name, lng, lat, d) {
        ...
        this.uav(name, null, function () {
            ...
            _this.on("uavChanged", { uav: _this.getUavData() });
        });
    };
    ...
    BaiduMapProvider.prototype.mapStyle = function (style) {
        if (style == "custom") {
...
}(_mapbase__WEBPACK_IMPORTED_MODULE_1__["MapBase"]));
var BaiduMapSelector = (function () {
...
var BaiduMapAnalysisArea = (function () {
    ...
    BaiduMapAnalysisArea.prototype.setBounds = function (bound) {
        if (bound) {
            ...
            this.evt.on("selectAnalysisArea", { sw: bound.getSouthWest(), ne: bound.getNorthEast() });
    ...
    BaiduMapAnalysisArea.prototype.disable = function () {
        ...
        if (this.border) {
            ...
            delete this.bound;
            delete this.border;
            this.evt.on("clearAnalysisArea");
        }
    };
    return BaiduMapAnalysisArea;
}());
/* harmony default export */ __webpack_exports__["default"] = (new BaiduMapProvider());
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!./map.css */ "./node_modules/css-loader/index.js!./src/map/map.css");
...
/*!****************************!*\
  !*** ./src/map/mapbase.ts ***!
  \****************************/
/*! exports provided: BlockContextImp, MapBase */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BlockContextImp", function() { return BlockContextImp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MapBase", function() { return MapBase; });
/* harmony import */ var _map_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./map.css */ "./src/map/map.css");
/* harmony import */ var _map_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_map_css__WEBPACK_IMPORTED_MODULE_0__);

var BlockContextImp = (function () {
    function BlockContextImp(center, pollutants) {
        var _this = this;
        this.points = [];
        this.reports = [];
        this.center = center;
    ...
    BlockContextImp.prototype.addPoint = function (p) {
    ...
    BlockContextImp.prototype.getPoints = function (query) {
        return this.points.filter(query);
    };
    BlockContextImp.prototype.getReports = function (query) {
        return this.reports.filter(query);
    };
    return BlockContextImp;
}());
